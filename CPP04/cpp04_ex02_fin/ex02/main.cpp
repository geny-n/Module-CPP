...
int main()
{
    ...
    std::cout << std::endl; 
    std::cout << "Type = " << animals[8]->getType() << std::endl;
    std::cout << "Type = " << animals[9]->getType() << std::endl; 
    std::cout << std::endl; 

    std::cout << std::endl; 
    std::cout << "Idea = " << animals[8]->getBrain()->getIdeas(0) << std::endl; 
    ...
    *copy_catcat = *catcat;
    ...
    Dog *dogdog = new Dog();
    dogdog->getBrain()->setIdeas(5, "I am a dogdog");
    ...
    *copy_dogdog = *dogdog;
    ...
    std::cout << "Idea dogdog = " << dogdog->getBrain()->getIdeas(5) << std::endl; 
    std::cout << "Idea copy_dogdog = " << copy_dogdog->getBrain()->getIdeas(5) << std::endl;
