...
{
	std::cout << "Bureaucrat default constructor called " << this->_Name << std::endl;
}
...
{
	std::cout << "Bureaucrat copy constructor called " << this->_Name << std::endl;
	*this = copy;
}

Bureaucrat& Bureaucrat::operator=(const Bureaucrat& f)
{
	std::cout << "Bureaucrat copy assignment constructor called " << this->_Name << std::endl;
...
{
	std::cout << "Bureaucrat is destroyed " << this->_Name << std::endl;
}
